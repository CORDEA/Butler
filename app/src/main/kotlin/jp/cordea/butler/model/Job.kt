...
data class Job(val name: String, val displayName: String, val url: String, @Json(name = "color") private val c: String?, val healthReport: List<HealthReport>, val lastBuild: Build?) {
